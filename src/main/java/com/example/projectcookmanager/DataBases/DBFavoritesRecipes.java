...
public class DBFavoritesRecipes extends DBAllRecipes{
    private Connection conn = null;
    static private String nameTable = "FavoritesRecipes";
    ...
    public List<Recipe> ReadAllOnFavorite(){
    ...
    public void WriteInFavorite(Recipe recipe){
        String sql = "INSERT INTO " + nameTable + "(idRecipe) VALUES(?)";
        boolean flag = false;
        for(Recipe recipe1 : ReadAllOnFavorite()){
